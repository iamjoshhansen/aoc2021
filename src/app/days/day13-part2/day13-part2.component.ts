...
@Component({
  selector: 'app-day13-part2',
  templateUrl: './day13-part2.component.html',
  styleUrls: ['./day13-part2.component.scss'],
})
export class Day13Part2Component extends Star implements OnInit {
  override ngOnInit() {
    super.ngOnInit();
    this.input = input;
  }
  ...
  async solve(input: string) {
    ...
    return pointsToString(finalPoints);
  }
}
