...
import { day11InputExample as input } from 'src/app/days/day11/day11-input';
...
export class Day11Component extends Star implements OnInit {
  override ngOnInit() {
    super.ngOnInit();
    this.input = input;
  }
  ...
  async solve(input: string) {
    ...
    for (let i = 0; i < 100; i++) {
      ...
      const flashCount = [...grid.allValues()].filter(
